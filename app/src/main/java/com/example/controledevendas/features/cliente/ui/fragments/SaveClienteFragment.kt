...
import com.example.controledevendas.databinding.ClienteFragmentSaveBinding
import com.example.controledevendas.features.cliente.ui.ClienteViewModel
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class SaveClienteFragment: Fragment() {
    private val viewModel: ClienteViewModel by viewModels()
    private val args: SaveClienteFragmentArgs by navArgs()
    private var _binding: ClienteFragmentSaveBinding? = null
    private val binding get() = _binding!!

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        _binding = DataBindingUtil.inflate(inflater, R.layout.cliente_fragment_save, container, false)
